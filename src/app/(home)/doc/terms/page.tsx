        ...
        <>
            <div style={{ padding: '2rem',backgroundColor: 'white' }}>
                ...
                <p style={{ color: 'rgb(68, 68, 68)' }}>
                    Ao acessar ao site <a href="https://project-sst-v-3-front.vercel.app/">e-commerce</a>, concorda em cumprir estes termos de serviço, todas as leis e regulamentos aplicáveis ​​e concorda que é responsável pelo cumprimento de todas as leis locais aplicáveis. Se você não concordar com algum desses termos, está proibido de usar ou acessar este site. Os materiais contidos neste site são protegidos pelas leis de direitos autorais e marcas comerciais aplicáveis.
                </p>

                <h2 style={{ color: 'rgb(68, 68, 68)' }}>2. Uso de Licença</h2>
                <p style={{ color: 'rgb(68, 68, 68)' }}>
                    É concedida permissão para baixar temporariamente uma cópia dos materiais (informações ou software) no site e-commerce, apenas para visualização transitória pessoal e não comercial. Esta é a concessão de uma licença, não uma transferência de título e, sob esta licença, você não pode:
                </p>
                ...
                <p style={{ color: 'rgb(68, 68, 68)' }}>
                    Os materiais exibidos no site da e-commerce podem incluir erros técnicos, tipográficos ou fotográficos. e-commerce não garante que qualquer material em seu site seja preciso, completo ou atual. e-commerce pode fazer alterações nos materiais contidos em seu site a qualquer momento, sem aviso prévio. No entanto, e-commerce não se compromete a atualizar os materiais.
                </p>

                <h2 style={{ color: 'rgb(68, 68, 68)' }}>6. Links</h2>
                <p style={{ color: 'rgb(68, 68, 68)' }}>
                    O e-commerce não analisou todos os sites vinculados ao seu site e não é responsável pelo conteúdo de nenhum site vinculado. A inclusão de qualquer link não implica endosso por e-commerce do site. O uso de qualquer site vinculado é por conta e risco do usuário.
                </p>

                <h3 style={{ color: 'rgb(68, 68, 68)' }}>Modificações</h3>
                <p style={{ color: 'rgb(68, 68, 68)' }}>
                    O e-commerce pode revisar estes termos de serviço do site a qualquer momento, sem aviso prévio. Ao usar este site, você concorda em ficar vinculado à versão atual desses termos de serviço.
                </p>

                <h3 style={{ color: 'rgb(68, 68, 68)' }}>Lei aplicável</h3>
                <p style={{ color: 'rgb(68, 68, 68)' }}>
                    Estes termos e condições são regidos e interpretados de acordo com as leis do e-commerce e você se submete irrevogavelmente à jurisdição exclusiva dos tribunais naquele estado ou localidade.
                </p>
            </div>
        </>
    )
